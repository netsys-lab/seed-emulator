...
br.crossConnect(73, 'br0', xc_nets.next_addr('51-73'))
...
br.crossConnect(51, 'br0', xc_nets.next_addr('51-73'))
...
scion.addIxLink(20, (1, 204), (1, 205), ScLinkType.Transit)
...
scion.addXcLink((1, 51), (1, 73), ScLinkType.Peer)
